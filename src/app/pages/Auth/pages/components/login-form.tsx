            ...
            <div className="form-content">
              ...
              <Form onSubmit={submit}>
                <Form.Item label="Username">
                  ...
                  })(<Input autoFocus={true} allowClear placeholder="User name" />)}
                </Form.Item>
                ...
                <Link className="float-right" to="/forget" style={{ float: 'right' }}>
                  Forgot password?
                </Link>
              ...
              <div>
                <a
                  href="/"
                  style={{ textAlign: 'center', width: '100%', display: 'block', marginTop: '30px', fontSize: '16px' }}
                >
                  Back to home
                </a>
              </div>
