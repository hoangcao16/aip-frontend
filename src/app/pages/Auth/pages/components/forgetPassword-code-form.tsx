...
export const ForgetPasswordCode = (props: IProps) => {
          ...
          <Col span={12} className="login-form">
            <div className="form-content">
              ...
              <Form onSubmit={submit}>
                <Form.Item label={'OTP code. Thời gian mã OTP còn hiệu lực: (' + timeLeft + ')'}>
...
export default Form.create<IProps>()(ForgetPasswordCode);
