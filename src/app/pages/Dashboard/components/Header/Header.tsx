...
import { logout, showChangePasswordForm } from '../../../Auth/redux/actions';
...
function Header(props: IProps) {
  ...
  const content = (
    <ul style={{ width: 160 }} className="popup-popover">
      <li>
        <Link to={'/admin/user/profile'}>Access dashboard</Link>
      </li>
      <li>
  ...
  return (
    <Row type="flex" justify="center" className="header-dasboard">
        ...
        <Menu mode="horizontal" onClick={handleClick}>
          ...
          <div className="userInfo">
            <Popover
              ...
              trigger="click"
            >
              {/* <Avatar src={props.auth?.employee.photo ? props.auth?.employee.photo : require('src/assets/images/avatar-default.png')} /> */}
              <span className="username">{`${props.auth?.user.full_name} `}</span>
              <Icon type="down" />
            </Popover>
          </div>
          {/* <div>
